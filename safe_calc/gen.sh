function genProto {
    ...
    mkdir -p $GO_OUT_PATH
    PBTS_OUT_DIR=/Users/xxh/projects/vue/nuxt-app/service/proto_gen/${DOMAIN}
    ...
    /Users/xxh/projects/go/safe/tools/gen_yaml/gen_yaml -root=/Users/xxh/projects/go/safe -packageName=${DOMAIN} -tsPath=$PBTS_OUT_DIR
